...
UNIX SA installed on this host
   ...
   $ ldd /usr/bin/xterm
   linux-vdso.so.l => (0x00007ffc69dfe000)
   libXft.so.2 => /lib64/libXft.so.2 (0x00007f84f87c8000)
   libfontconfig.so.l => /lib64/libfontconfig.so.l (0x00007f84f858a000)
   ...
   libXll.so.6 => /lib64/libXll.so.6 (0x00007f84f7735000)
