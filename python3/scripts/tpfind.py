...
examples:
    ...
    tpfind.py -he 'r["type"] != "link" and r["mode"] & 0022' -ha 'ls(r)' ~/github/tpsup

    # mode, find dir not executable or readable
    tpfind.py -he 'r["type"] == "dir" and (r["mode"] & 0555) != 0555' -ha 'ls(r)' ~/github/tpsup
    ...
    -ha 'if re.search(r"^#!.*/bash\\b",ifh.readline()): ls(r)' ~/github/tpsup
    """)
