...
our $our_cfg = {
   ...
   cfg_by_entity => {
      ...
      applog_cmd_grep_keys => {
         ...
         method_cfg => {
            # to test: tptrace_test -t applog_cmd_grep_keys bookid=BKG-0001
            type  => 'grep_keys',
            ...
            file => '{{cfgdir}}/tptrace_test.log {{cfgdir}}/tptrace_test2.log', # to be split by \s
      ...
      applog_cmd_pipe => {
        # to test: tptrace_test -t applog_cmd_pipe bookid=BKG-0001 tradeid=TRD-0001
         method => 'cmd', 

         vars => [ 
            log => '"{{cfgdir}}/tptrace_test.log {{cfgdir}}/tptrace_test2.log"',  
         ],
...
END
   ...
   {{prog}} -t applog_cmd_grep_keys bookid=BKG-0001
   {{prog}} -t applog_cmd_pipe bookid=BKG-0001 tradeid=TRD-0001
   {{prog}} -t applog_cmd_pipe_tpgrepl bookid=BKG-0001 tradeid=TRD-0001
